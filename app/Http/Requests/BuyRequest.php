...
class BuyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'purchase_details.*.quantity_buy_product'  => 'nullable|numeric|min:1',
            'purchase_details.*.price_buy'             => 'nullable|numeric|min:1',
            'purchase_details.*.bulk'                  => 'nullable',

            'option.porcentaje'       => 'required|numeric|min:0',

            'bulks'                   => 'nullable|array',
            'bulks.*.units_per_bulk'       => 'required|numeric|min:1',
            'bulks.*.quantity_bulk'        => 'required|numeric|min:1',
            'bulks.*.price_per_bulk'       => 'required|numeric|min:1',
        ];
    }
}
